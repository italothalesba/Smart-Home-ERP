      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="flex bg-white p-1 rounded-2xl border border-slate-200 shadow-sm w-full md:w-auto">
          <button 
            ...
            className="flex-1 md:flex-none px-4 md:px-6 py-3 md:py-2.5 bg-slate-50 text-slate-600 rounded-xl flex items-center justify-center gap-2 text-[10px] font-black uppercase tracking-widest transition-all cursor-pointer mr-1 active:scale-95"
          >
            Sugerir IA
          </button>
          <button 
            ...
            className={cn(
              "flex-1 md:flex-none flex items-center justify-center gap-2 px-4 md:px-6 py-3 md:py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all cursor-pointer active:scale-95",
                  ...
                  <div className="grid gap-4">
                    {dayMeals.map(meal => (
                      <motion.div 
                        layout
                        key={meal.id} 
                        className="bg-white rounded-[28px] p-4 md:p-5 border border-slate-100 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4 group"
                      >
                        <div className="flex gap-4 items-center min-w-0">
                          <div className="w-12 h-12 md:w-14 md:h-14 rounded-2xl bg-slate-50 text-slate-800 flex items-center justify-center shrink-0 shadow-sm border border-white">
                            <ChefHat size={20} className="md:w-6 md:h-6" />
                          </div>
                          <div className="min-w-0">
                            <div className="flex flex-wrap items-center gap-2 mb-1">
                               <span className="text-[8px] md:text-[9px] font-black text-emerald-600 uppercase tracking-widest bg-emerald-50 px-2 py-0.5 rounded-md border border-emerald-100">
                                 {MEAL_TYPE_LABELS[meal.type]}
                               </span>
                               <span className="text-[8px] md:text-[9px] font-black text-slate-400 uppercase tracking-widest bg-slate-100 px-2 py-0.5 rounded-md flex items-center gap-1">
                                 Servir: 
                                 <input 
                                   type="number"
                                   min="1"
                            ...
                            <h4 className="text-sm font-black text-slate-900 truncate tracking-tight">{meal.title}</h4>
                            <div className="flex flex-wrap items-center gap-3 mt-2">
                               <button 
                                 onClick={() => setSelectedMealId(meal.id)}
                                 className="text-[9px] font-black text-emerald-600 uppercase flex items-center gap-1.5 cursor-pointer h-8 px-2 bg-emerald-50 md:bg-transparent rounded-lg"
                               >
